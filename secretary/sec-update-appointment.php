<?php
    ...
    if(isset($_POST['make_appointment']))
    {
            ...
            $rc=$stmt->bind_param('sssi', $c_preff_date, $c_speciality, $c_app_speciality, $c_id);
            $stmt->execute();
                if($stmt)
                {
              ...
              <div class="card card-border-color card-border-color-primary">
                ...
                <div class="card-body">
                  <form method ="POST">
                    ...
                    <div class="col-sm-6">
                        <p class="text-right">
                          <input class="btn btn-space btn-primary" value ="Submit" name = "make_appointment" type="submit">
