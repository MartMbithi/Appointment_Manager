<?php
    ...
    if(isset($_POST['Update_profile_pic']))
    {
            ...
            */
		    ...
		    //$id=intval($_GET['id']);
		        move_uploaded_file($_FILES["s_dpic"]["tmp_name"],"assets/img/".$_FILES["s_dpic"]["name"]);
            $query="update  ams_secretary set s_dpic = ? where s_id=?";
            $stmt = $mysqli->prepare($query);
            $rc=$stmt->bind_param('si', $s_dpic, $aid);
            $stmt->execute();
                if($stmt)
                {
                  ...
                  <form method ="POST" enctype="multipart/form-data">
                    <div class="form-group row">
                      ...
                      <div class="col-12 col-sm-8 col-lg-6">
                        <input class="btn btn-outline-success" name="s_dpic"  id="inputText3" type="file">
                      </div>
                    </div>
