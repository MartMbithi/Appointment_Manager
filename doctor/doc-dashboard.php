        ...
        <div class="row">
            ...
            <div class="chart sparkline"><i class="material-icons">burst_mode</i></div>
              ...
              <?php
                  ...
                  $stmt = $mysqli->prepare($result);
                  $stmt->execute();
                  $stmt->bind_result($mess);
                  $stmt->fetch();
                  $stmt->close();
                ?>
                <div class="desc">Messages</div>
                <div class="value"><span class="indicator indicator-negative mdi mdi-chevron-right"></span><span class="number" data-toggle="counter" data-end="<?php echo $mess;?>"><?php echo $mess;?></span>
                </div>
              </div>
            </div>
            </div>
          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="card card-table">
                <div class="card-header">Client Appointments
                  ...
                  <table class="table table-striped table-hover table-fw-widget" id="table1">
                    <thead>
                      <tr>
                        ...
                        <th>Appointment Speciality</th>
                        
                      </tr>
                    </thead>
                    <tbody>
                      <?php
                        $ret="SELECT DISTINCT *  FROM ams_client  "; //sql code to get all appointment.
                        $stmt= $mysqli->prepare($ret) ;
                        $stmt->execute() ;//ok
                        $res=$stmt->get_result();
                        $cnt=1;
