  ...
  <body>
    ...
    <!--Navigation Bar-->
      ...
      <!--End Sidebar-->
        ...
        <?php
            $aid=$_SESSION['a_id'];//Assaign session variable to passenger ID
            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="user-display">
                  <div class="user-display-bg"><img src="assets/img/<?php echo $row->a_dpic;?>" alt="Profile Background"></div>
                  <div class="user-display-bottom">
                    <div class="user-display-avatar"><img src="assets/img/<?php echo $row->a_dpic;?>" alt="Avatar"></div>
                    <div class="user-display-info">
                      <div class="name"><?php echo $row->a_name;?></div>
                    </div>
