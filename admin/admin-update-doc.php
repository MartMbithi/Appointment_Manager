<?php
    ...
    if(isset($_POST['add_doc']))
    {
            ...
            $query="update  ams_doc  set doc_fname=?, doc_lname=?, doc_phone=?, doc_dept=?, doc_status=?, doc_addr=?, doc_email=?, doc_pwd=? where doc_id=?";
            $stmt = $mysqli->prepare($query);
            $rc=$stmt->bind_param('ssssssssi', $doc_fname,  $doc_lname, $doc_phone, $doc_dept, $doc_status, $doc_addr, $doc_email, $doc_pwd, $id);
            $stmt->execute();
                if($stmt)
                {
                    $succ = "Doctor Updated";
              ...
              <div class="card card-border-color card-border-color-primary">
                ...
                <div class="card-body">
                  <form method ="POST">
                    ...
                    <div class="col-sm-6">
                        <p class="text-right">
                          <input class="btn btn-space btn-primary" value ="Update Doctor" name = "add_doc" type="submit">
