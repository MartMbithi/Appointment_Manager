<?php
    ...
    if(isset($_POST['Update_profile_pic']))
    {
            ...
            */
		    ...
		    //$id=intval($_GET['id']);
		        move_uploaded_file($_FILES["a_dpic"]["tmp_name"],"assets/img/".$_FILES["a_dpic"]["name"]);
            $query="update  ams_admin set a_dpic = ? where a_id=?";
            $stmt = $mysqli->prepare($query);
            $rc=$stmt->bind_param('si', $a_dpic, $aid);
            $stmt->execute();
                if($stmt)
                {
        ...
        <div class="page-head">
          ...
          <nav aria-label="breadcrumb" role="navigation">
            <ol class="breadcrumb page-head-nav">
              ...
              <li class="breadcrumb-item active"> Profile Photo </li>
            </ol>
          </nav>
        </div>
            <?php if(isset($succ)) {?>
                  ...
                  <form method ="POST" enctype="multipart/form-data">
                    <div class="form-group row">
                      ...
                      <div class="col-12 col-sm-8 col-lg-6">
                        <input class="btn btn-outline-success" name="a_dpic"  id="inputText3" type="file">
                      </div>
                    </div>
                   
                    <div class="col-sm-6">
                        <p class="text-right">
                          <input class="btn btn-space btn-primary" value ="Update Profile" name = "Update_profile_pic" type="submit">
