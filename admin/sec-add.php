<?php
    ...
    if(isset($_POST['add_sec']))
    {
            ...
            $query="insert into ams_secretary ( s_fname, s_lname, s_phone, s_addr, s_email, s_pwd) values(?,?,?,?,?,?)";
            $stmt = $mysqli->prepare($query);
            $rc=$stmt->bind_param('ssssss', $s_fname,  $s_lname, $s_phone, $s_addr, $s_email, $s_pwd);
            $stmt->execute();
                if($stmt)
                {
                    $succ = "Secretary Added";
                }
                else 
                {
  ...
  <body>
    ...
    <!--Navigation Bar-->
      ...
      <div class="be-content">
        <div class="page-head">
          <h2 class="page-head-title">Add Secretary</h2>
                  ...
                  <form method ="POST">
                    <div class="form-group row">
                      ...
                      <div class="col-12 col-sm-8 col-lg-6">
                        <input class="form-control" name="s_fname"  id="inputText3" type="text">
                      </div>
                    </div>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-12 col-sm-8 col-lg-6">
                        <input class="form-control" name="s_lname"  id="inputText3" type="text">
                      </div>
                    </div>
                    <div class="form-group row">
                      <label class="col-12 col-sm-3 col-form-label text-sm-right" for="inputText3">Phone Number</label>
                      <div class="col-12 col-sm-8 col-lg-6">
                        <input class="form-control" name="s_phone"  id="inputText3" type="text">
                      </div>
                    </div>
                    <div class="form-group row">
                      <label class="col-12 col-sm-3 col-form-label text-sm-right" for="inputText3">Address</label>
                      <div class="col-12 col-sm-8 col-lg-6">
                        <input class="form-control" name="s_addr"  id="inputText3" type="text">
                      </div>
                    </div>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-12 col-sm-8 col-lg-6">
                        <input class="form-control" name="s_email"  id="inputText3" type="text">
                      </div>
                    </div>
                    ...
                    <div class="col-sm-6">
                        <p class="text-right">
                          <input class="btn btn-space btn-primary" value ="Add Secretary" name = "add_sec" type="submit">
