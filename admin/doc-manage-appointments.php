                  ...
                  <table class="table table-striped table-hover table-fw-widget" id="table1">
                    ...
                    <?php
                      ...
                      <tr class="odd gradeX even gradeC odd gradeA even gradeA ">
                        ...
                        <td class="center"><a class ="badge badge-success" href ="doc-update-appointment.php?c_id=<?php echo $row->c_id;?>">Approve</a> 
                            <a class ="badge badge-danger" href ="doc-delete-appointment.php?c_id=<?php echo $row->c_id;?>">Delete</a>
                            <a class ="badge badge-primary" href ="doc-view-appointment-status.php?c_id=<?php echo $row->c_id;?>">View</a>
                        </td> 
                      </tr>
                        <?php }?>
                    </tbody>
